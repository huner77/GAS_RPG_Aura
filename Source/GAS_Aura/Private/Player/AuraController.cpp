...
void AAuraController::SetupInputComponent()
{
	...
	UEnhancedInputComponent* UEnhanceInputComponent = CastChecked<UEnhancedInputComponent>(InputComponent);

	UEnhanceInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AAuraController::Move);
}
